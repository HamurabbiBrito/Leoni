...
const DeleteButton = ({ onClick, className = "", size = "md" }) => {
  ...
  return (
    <button 
      onClick={onClick}
      className={`group relative flex flex-col items-center justify-center overflow-hidden rounded-xl border-2 border-red-800 bg-red-400 hover:bg-red-600 ${selectedSize} ${className}`}
    >
      <svg 
      ...
      <svg 
        ...
        fill="none" 
        viewBox="0 0 33 39" 
        className="origin-right duration-500"
      >
